...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        # Create a user
        # 這邊因為 perms.catalog.can_mark_returned 只有 superuser可以通行，把 testuser2 改用 create_superuser
        test_user1 = User.objects.create_user(username='testuser1', password='1X<ISRUkw+tuK')
...
#(4)
    ...
    #現在一直出現302問題，出自我發現 renew-book-librarian 導入到 url、引用 renew_book_librarian的view 與回傳 book_renew_librarian.html
    #302 重定向到login
...
#(6)
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        self.assertRedirects(response, reverse('all-borrowed'))#book/<uuid:pk>/renew/ vs borrowed_books/
#(7)
